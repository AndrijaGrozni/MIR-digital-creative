$(function() {
    $('.wrapper-services .right-side li').on('click', function(){
        var panelToShow = $(this).attr('rel');
        
        $('.wrapper-services .rectangle.active').slideUp(500, function(){
...
$(function() {
$('.crew-box._1').click(function(){
            $('.info1').slideToggle(400);
      })
$('.crew-box._2').click(function(){
            $('.info2').slideToggle(400);
      })
$('.crew-box._3').click(function(){
            $('.info3').slideToggle(400);
      })
$('.crew-box._4').click(function(){
            $('.info4').slideToggle(400);
      })
$('.crew-box._5').click(function(){
            $('.info5').slideToggle(400);
      })
});
